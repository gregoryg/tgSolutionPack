...
## Load from csv
LOAD DATA LOCAL INFILE '../data/ratings.sample.csv' INTO TABLE ratings CHARACTER SET UTF8 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS (userId,movieId,rating,tmstamp);
...
LOAD DATA LOCAL INFILE '../data/movie.csv' INTO TABLE movies CHARACTER SET UTF8 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS (movieId,title,genres);
