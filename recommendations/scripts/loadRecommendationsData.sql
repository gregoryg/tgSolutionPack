...
LOAD DATA LOCAL INFILE './recommendations/data/title.basics.sample.tsv' INTO TABLE titles FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' IGNORE 1 ROWS (tconst,titleType,primaryTitle,originalTitle,isAdult,startYear,endYear,runtimeMinutes,genres);
LOAD DATA LOCAL INFILE './recommendations/data/movie.csv' INTO TABLE movies FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (movieId,title,genres);
LOAD DATA LOCAL INFILE './recommendations/data/friendships.csv' INTO TABLE friendships FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (person,friend,dateMet);
LOAD DATA LOCAL INFILE './recommendations/data/people.csv' INTO TABLE people FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (nameId,firstName,lastName,gender,age,language);
LOAD DATA LOCAL INFILE './recommendations/data/link.csv' INTO TABLE links FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (movieId,imdbId,tmdbId);
LOAD DATA LOCAL INFILE './recommendations/data/tag.sample.csv' INTO TABLE tags FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS (userId,movieId,tag,tmstamp);
