...
## Load from csv
LOAD DATA LOCAL INFILE './data/comments_0_0.csv' INTO TABLE comment FIELDS TERMINATED BY '|' LINES TERMINATED BY '\n' IGNORE 1 ROWS (id,creationDate,locationIP,browserUsed,content,length);
...
LOAD DATA LOCAL INFILE './data/post_0_0.csv' INTO TABLE post FIELDS TERMINATED BY '|' LINES TERMINATED BY '\n' IGNORE 1 ROWS (id,imageFile,creationDate,locationIP,browserUsed,language,content,length);
