...
## Load from csv
LOAD DATA LOCAL INFILE './imdb/data/title.basics.sample.tsv' INTO TABLE title_basics FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' IGNORE 1 ROWS (titleId,titleType,primaryTitle,originalTitle,isAdult,startYear,endYear,runtimeMinutes,genres);
LOAD DATA LOCAL INFILE './imdb/data/name.basics.sample.tsv' INTO TABLE name_basics FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' IGNORE 1 ROWS (nameId,primaryName,birthYear,deathYear,primaryProfession,knownForTitles);
LOAD DATA LOCAL INFILE './imdb/data/title.ratings.sample.tsv' INTO TABLE title_ratings FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' IGNORE 1 ROWS (titleId,averageRating,numVotes);
LOAD DATA LOCAL INFILE './imdb/data/title.principals.sample.tsv' INTO TABLE title_principals FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' IGNORE 1 ROWS (principalId,ordering,nameId,category,job,characters);
