...
DROP DATABASE IF EXISTS adWorks;
CREATE DATABASE IF NOT EXISTS adWorks;
USE adWorks;
...
CREATE TABLE `SalesTerritory` (
  ...
  REFERENCES `CountryRegion` (`CountryRegionCode`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `StateProvince` (
  ...
  REFERENCES `SalesTerritory` (`TerritoryID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `Address` (
  ...
  REFERENCES `StateProvince` (`StateProvinceID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `BillOfMaterials` (
  ...
  REFERENCES `UnitMeasure` (`UnitMeasureCode`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `BusinessEntityAddress` (
  ...
  REFERENCES `AddressType` (`AddressTypeID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  REFERENCES `BusinessEntity` (`BusinessEntityID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `BusinessEntityContact` (
  ...
  REFERENCES `ContactType` (`ContactTypeID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_BusinessEntityContact_Person_PersonID` FOREIGN KEY (`PersonID`)
  REFERENCES `Person` (`BusinessEntityID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `CountryRegionCurrency` (
  ...
  REFERENCES `Currency` (`CurrencyCode`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `Customer` (
  ...
  REFERENCES `Store` (`BusinessEntityID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `Document` (
  ...
  REFERENCES `Employee` (`BusinessEntityID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `EmployeeDepartmentHistory` (
  ...
  REFERENCES `Shift` (`ShiftID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `PersonCreditCard` (
  ...
  REFERENCES `CreditCard` (`CreditCardID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `PersonPhone` (
  ...
  REFERENCES `PhoneNumberType` (`PhoneNumberTypeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `Product` (
  ...
  REFERENCES `ProductModel` (`ProductModelID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Product_ProductSubcategory_ProductSubcategoryID` FOREIGN KEY (`ProductSubcategoryID`)
  REFERENCES `ProductSubcategory` (`ProductSubcategoryID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `ProductDocument` (
  ...
  REFERENCES `Document` (`DocumentNode`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `ProductInventory` (
  ...
  REFERENCES `Location` (`LocationID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `ProductModelIllustration` (
  ...
  REFERENCES `Illustration` (`IllustrationID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `ProductModelProductDescriptionCulture` (
  ...
  REFERENCES `Culture` (`CultureID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_ProductModelProductDescriptionCulture_ProductDescription_Pr3` FOREIGN KEY (`ProductDescriptionID`)
  REFERENCES `ProductDescription` (`ProductDescriptionID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_ProductModelProductDescriptionCulture_ProductModel_ProductM4` FOREIGN KEY (`ProductModelID`)
  REFERENCES `ProductModel` (`ProductModelID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ProductProductPhoto` (
  ...
  REFERENCES `ProductPhoto` (`ProductPhotoID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `ProductSubcategory` (
  ...
  REFERENCES `ProductCategory` (`ProductCategoryID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ProductVendor` (
  ...
  REFERENCES `Vendor` (`BusinessEntityID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `PurchaseOrderDetail` (
  ...
  REFERENCES `PurchaseOrderHeader` (`PurchaseOrderID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `PurchaseOrderHeader` (
  ...
  REFERENCES `ShipMethod` (`ShipMethodID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `SalesOrderDetail` (
  ...
  REFERENCES `SalesOrderHeader` (`SalesOrderID`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `FK_SalesOrderDetail_SpecialOfferProduct_SpecialOfferIDProductID` FOREIGN KEY (`SpecialOfferID`, `ProductID`)
  REFERENCES `SpecialOfferProduct` (`SpecialOfferID`, `ProductID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `SalesOrderHeader` (
  ...
  REFERENCES `CurrencyRate` (`CurrencyRateID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  REFERENCES `SalesPerson` (`BusinessEntityID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `SalesOrderHeaderSalesReason` (
  ...
  REFERENCES `SalesReason` (`SalesReasonID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `SpecialOfferProduct` (
  ...
  REFERENCES `SpecialOffer` (`SpecialOfferID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `WorkOrder` (
  ...
  REFERENCES `ScrapReason` (`ScrapReasonID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `WorkOrderRouting` (
  ...
  REFERENCES `WorkOrder` (`WorkOrderID`) ON DELETE NO ACTION ON UPDATE NO ACTION
