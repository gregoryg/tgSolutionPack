...
conn.gsql(''' 
USE GLOBAL
DROP GRAPH GraphConvolutionalNetworkGraph

CREATE GRAPH GraphConvolutionalNetworkGraph()
USE GRAPH GraphConvolutionalNetworkGraph

CREATE SCHEMA_CHANGE JOB GraphConvolutionalNetworkGraph_change_job FOR GRAPH GraphConvolutionalNetworkGraph {
...
RUN SCHEMA_CHANGE JOB GraphConvolutionalNetworkGraph_change_job
DROP JOB GraphConvolutionalNetworkGraph_change_job
''', options=[])
