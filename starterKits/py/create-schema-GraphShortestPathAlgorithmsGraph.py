...
conn.gsql(''' 
USE GLOBAL
DROP GRAPH GraphShortestPathAlgorithmsGraph

CREATE GRAPH GraphShortestPathAlgorithmsGraph()
USE GRAPH GraphShortestPathAlgorithmsGraph

CREATE SCHEMA_CHANGE JOB GraphShortestPathAlgorithmsGraph_change_job FOR GRAPH GraphShortestPathAlgorithmsGraph {
...
RUN SCHEMA_CHANGE JOB GraphShortestPathAlgorithmsGraph_change_job
DROP JOB GraphShortestPathAlgorithmsGraph_change_job
''', options=[])
