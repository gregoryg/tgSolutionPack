...
CREATE LOADING JOB ShortestPathGraph_load_job FOR GRAPH ShortestPathGraph {

LOAD "ANY:$sys.data_root/GlobalTypes/Airport.csv" TO VERTEX Airport VALUES ($"primary_id", $"name", $"city", $"country", $"IATA", $"latitude", $"longitude") USING SEPARATOR = "", HEADER = "true";
...
RUN LOADING JOB ShortestPathGraph_change_job
