...
conn.gsql(''' 
USE GLOBAL
DROP GRAPH GraphCommunityDetectionGraph

CREATE GRAPH GraphCommunityDetectionGraph()
USE GRAPH GraphCommunityDetectionGraph

CREATE SCHEMA_CHANGE JOB GraphCommunityDetectionGraph_change_job FOR GRAPH GraphCommunityDetectionGraph {
...
RUN SCHEMA_CHANGE JOB GraphCommunityDetectionGraph_change_job
DROP JOB GraphCommunityDetectionGraph_change_job
''', options=[])
